      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        {decks.map((deck) => (
          <Link
            ...
            className="group cursor-pointer overflow-hidden rounded-2xl border border-slate-200 bg-white transition-all hover:shadow-2xl hover:shadow-primary/10"
          >
            ...
            <div className="p-5">
              <h3 className="truncate text-sm font-bold text-slate-900 transition-colors group-hover:text-primary">
                {deck.title}
              </h3>
