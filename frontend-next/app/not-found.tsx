...
export default function NotFound() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-background-dark text-slate-400 font-display">
      <span className="material-symbols-outlined mb-4 text-6xl text-primary">
        search_off
      </span>
      <h1 className="mb-2 text-3xl font-bold text-slate-100">404</h1>
